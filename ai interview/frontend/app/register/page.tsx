...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("cvmaster_user", JSON.stringify(data.user))
      localStorage.setItem("cvmaster_token", data.access_token)
  ...
  const handleGmailSignup = () => {
    setLoading(true)
    // TODO: Implement actual Google OAuth with your Laravel backend
    // This is a placeholder - you'll need to implement OAuth properly
    setTimeout(() => {
      const user = {
